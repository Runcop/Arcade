...
#define FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h_23_RPC_WRAPPERS_NO_PURE_DECLS \
...
#define FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h_23_INCLASS_NO_PURE_DECLS \
private: \
...
#define FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h_23_ENHANCED_CONSTRUCTORS \
	...
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(ACC_PingPongController) \
	NO_API virtual ~ACC_PingPongController();


#define FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h_20_PROLOG
#define FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h_23_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h_23_RPC_WRAPPERS_NO_PURE_DECLS \
	FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h_23_INCLASS_NO_PURE_DECLS \
	FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h_23_ENHANCED_CONSTRUCTORS \
private: \
...
#define CURRENT_FILE_ID FID_UnrealProjects_Arcade_Source_Arcade_Public_Pong_CC_PingPongController_h

// ********** Begin Enum EPlayer *******************************************************************
#define FOREACH_ENUM_EPLAYER(op) \
	op(EPlayer::PlayerOne) \
	op(EPlayer::PlayerTwo) 

enum class EPlayer : uint8;
template<> struct TIsUEnumClass<EPlayer> { enum { Value = true }; };
